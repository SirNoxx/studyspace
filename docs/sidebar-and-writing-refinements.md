...
12. Keep a single right-sidebar toggle beside Zen/fullscreen in the note header. It remains available to reopen the sidebar after closing it. Remove the duplicate close button from the sidebar header.
